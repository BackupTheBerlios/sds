...
struct DsFitParm yyparam={0,   /* set     */
			  0,   /* parsset */
			  0.0, /* min     */
			  0.0, /* max     */
			  0,   /* nop     */
...
%token	T_TOL	T_INT	T_FTO	T_XTO	T_GTO	T_SIG	T_ITE	T_PARS

%token	T_DOUBLE T_RES	T_REP	T_TR    T_FNC   T_STRING

%type <ival> T_INT T_PARS
...
%%
	...
	oneexp: T_MIN T_DOUBLE  { yyparam.min=$2; yyparam.set|=MIN_SET; }
		...
		| T_FTO T_DOUBLE  { yyparam.ftol=$2; yyparam.set|=FTO_SET;}
		| T_FTO T_INT  { yyparam.ftol=$2; yyparam.set|=FTO_SET;}
		| T_XTO T_DOUBLE  { yyparam.xtol=$2; yyparam.set|=XTO_SET;}
		| T_XTO T_INT  { yyparam.xtol=$2; yyparam.set|=XTO_SET;}
		| T_GTO T_DOUBLE  { yyparam.gtol=$2; yyparam.set|=GTO_SET;}
		| T_GTO T_INT  { yyparam.gtol=$2; yyparam.set|=GTO_SET;}
		| T_ITE T_INT  { yyparam.itera=$2; yyparam.set|=ITE_SET;}
		| T_TOL T_DOUBLE  { yyparam.ftol=$2;
			yyparam.xtol=$2;
			yyparam.gtol=0.0;
 			yyparam.set|=FTO_SET|XTO_SET|GTO_SET;
		}
		| T_TOL T_INT  { yyparam.ftol=$2;
			yyparam.xtol=$2;
			yyparam.gtol=0.0;
 			yyparam.set|=FTO_SET|XTO_SET|GTO_SET;
		}
		...
		| T_PARS T_DOUBLE  { yyparam.pars[$1]=$2;
					yyparam.parset|=1<<$1; }
		| T_PARS T_INT  { yyparam.pars[$1]=$2;
					yyparam.parset|=1<<$1; }
		| T_PARS '='  { yyparam.fit[$1]=0; yyparam.parset|=1<<$1; }
		| T_PARS '?'  { yyparam.fit[$1]=1; yyparam.parset|=1<<$1; }
                | T_FNC T_STRING { yyparam.func=$2 ; 
		                   yyparam.set|=FNC_SET; }
		| T_SIG sigma_exp  {
			yyparam.set|=SIG_SET;
			if(nadded) {
