...
/*
  ...
  are better optimized for the case of 8-byte alignment.)
...
/*
  ...
  to 8 4byte fields, or most strings representing words, tokens, etc. Using
...
/*
  Emulation of sbrk for WIN32. Code within ifdef WIN32 is untested (and
  not even understood!) by me, but is reported by many people to work.
...
/*
  ...
  so that it will trigger on first malloc call (because the static "av" 
  is zeroed),  and in turn trigger an initialization check.
*/
