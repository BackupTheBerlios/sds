...
c
c  input parameters:
c    t    : real*8 array,length n, containing the knots.
c    n    : integer, containing the number of knots.
c    par  : real*8, containing the value of the parameter par.
c
c  output parameters:
c    ress  : real*8 array,length n, containing the integrals ress(j).
c    resc  : real*8 array,length n, containing the integrals resc(j).
c
c  restrictions:
